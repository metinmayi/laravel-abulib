...
<body class="min-h-screen flex bg-gray-50 text-gray-800">
    ...
    <main class="max-w-6xl p-6 mt-10 w-3/4">
        ...
        <form action="{{ route('variant.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" id="title" name="title" placeholder="Enter the title of the literature" required
                class="block w-full p-2 border rounded mb-4">

            <label for="description" class="block text-sm font-medium mb-2">Description:</label>
            <textarea type="text" id="description" name="description" placeholder="Enter the description of the literature"
                required class="block w-full p-2 border rounded mb-4"></textarea>
